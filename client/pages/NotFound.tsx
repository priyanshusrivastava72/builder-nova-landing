        ...
        <div className="text-center max-w-2xl mx-auto">
          <Card className="p-8 border-0 shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl text-legal-900">
                Page Coming Soon
              </CardTitle>
              <CardDescription className="text-lg mt-4">
                This feature is currently in development. We're building
                something amazing!
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="bg-legal-50 rounded-lg p-6 border border-legal-200">
                <h3 className="font-semibold text-legal-800 mb-2">
                  Want this page built?
                </h3>
                <p className="text-muted-foreground mb-4">
                  Continue the conversation with our AI assistant to have this
                  specific feature page designed and implemented for you.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  className="border-legal-200 hover:bg-legal-50 min-w-[140px]"
                >
                  View All Features
                </Button>
              </div>
